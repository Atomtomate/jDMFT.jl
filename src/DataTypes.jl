...
#   Last Edit Date  : 10.09.22                                                                         #
# ----------------------------------------- Description ---------------------------------------------- #
#   Data structures for use in DMFT and Impurity solvers.                                              #
# -------------------------------------------- TODO -------------------------------------------------- #
#   - Use ModelParameters and SimulationParameters from LadderDGA.jl (define HubbardModel.jl?)         #
# ==================================================================================================== #
